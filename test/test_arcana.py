...
def test_cardgallery(browser):
    browser.visit("https://www.archonarcana.com/wiki/Card_Gallery?order_by=House+Name")
    time.sleep(2)
...
def test_topsearch(browser):
    browser.visit("https://www.archonarcana.com/wiki/Main_Page")
    time.sleep(0.5)
...
def test_cards(browser):
    #Dark Amber Vault
    browser.visit("https://www.archonarcana.com/wiki/Dark_%C3%86mber_Vault")
...
def test_validate_generic_card(browser, card_name):
    browser.visit("https://www.archonarcana.com/wiki/"+card_name)
